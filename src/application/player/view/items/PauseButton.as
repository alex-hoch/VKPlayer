...
package application.player.view.items {
	...
	public class PauseButton extends BaseButton {
		...
		override protected function get states():ButtonStates {
			...
			result.up = drawState(2, 0x555555, 0xdddddd);
			result.over = drawState(2, 0x555555, 0xaaaaaa);
			result.down = drawState(2, 0x555555, 0x777777);
			result.disable = drawState(2, 0x555555, 0xdddddd);
			return result;
		}
		...
		//  Private methods
		//--------------------------------------------------------------------------
		private function drawState(lineThickness:int, lineColor:uint, bgColor:uint):Sprite {
			...
			gr.drawRoundRect(-13, -15, 10, 29, 5);
			gr.drawRoundRect(2, -15, 10, 29, 5);
			gr.endFill();
